...
$messages = [
    [
        ...
        - Є син Йосип, йому 18. вчиться у Граці.
        - Є син Мартин, живе в Україні, в селі Білки, відвідує школу в місті Іршава, має 12 років.
        ...
        - Завжди відповідай тією мовою, якою поставлено запитання. Якщо тебе просять відповідати іншою мовою, відповідай іншою.
        - Якщо не можеш визначити мову, використовуй англійську."
    ],
    [
        "role" => "user",
        "content" => $question
